# Generated by Django 5.0.6 on 2024-06-28 01:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='shipping',
            name='order',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.orderuser'),
        ),
        migrations.AddField(
            model_name='productsize',
            name='size_product',
        ...
        migrations.AddConstraint(
            model_name='shipping',
            constraint=models.UniqueConstraint(fields=('order',), name='unique_shipping_order'),
        ),
        migrations.AddConstraint(
            model_name='productsize',
